...
QATA_ROOT = os.path.join(DATA_ROOT, 'QaTa-COV19-v2')
...
train_dataset = os.path.join(QATA_ROOT, 'Train_Folder')
val_dataset = os.path.join(QATA_ROOT, 'Val_Folder')
test_dataset = os.path.join(QATA_ROOT, 'Test_Folder')

session_name = 'session' + '_' + time.strftime('%m.%d_%Hh%M') + '_QaTa'
